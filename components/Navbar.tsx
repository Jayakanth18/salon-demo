        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6">
            ...
            <div className="relative group">
              <button className="text-gray-700 hover:text-[#d4a574] transition-colors flex items-center gap-1">
                Pages
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <div className="lg:absolute hidden group-hover:block bg-gray-100 lg:mt-2 lg:shadow-lg rounded">
                <Link
                  href="/team"
                  className="block px-4 py-2 text-gray-700 hover:bg-[#d4a574] hover:text-white transition-colors"
                >
                  Our Team
                </Link>
                <Link
