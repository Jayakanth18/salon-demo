  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="text-center">
        <h1 className="text-9xl font-bold text-[#6DEAED] mb-4">404</h1>
        ...
        <div className="flex gap-4 justify-center">
          <Link
            href="/"
            className="bg-[#6DEAED] text-white px-8 py-4 hover:bg-[#5BD4D7] transition-colors uppercase font-semibold"
          >
            Go Home
          </Link>
          <Link
