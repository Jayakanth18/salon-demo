  ...
  return (
    <main>
            ...
            <div className="py-16 lg:py-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h5 className="text-[#d4a574] font-semibold mb-0">Call Us</h5>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h5 className="text-[#d4a574] font-semibold mb-0">Mail Us</h5>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <Link href="/about" className="bg-[#d4a574] text-white px-8 py-4 inline-block hover:bg-[#c39563] transition-colors uppercase font-semibold">
                Read More
              </Link>
            </div>
          </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="font-dancing-script text-[#d4a574] text-4xl">Our Services</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                ...
                <Link href="/service" className="text-sm bg-[#d4a574] text-white px-4 py-2 inline-flex items-center gap-2 hover:bg-[#c39563] transition-colors uppercase font-semibold">
                  Read More
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="font-dancing-script text-[#d4a574] text-4xl">Team Members</h1>
            <h1 className="text-4xl font-bold">Our Experienced Specialists</h1>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: "Lily Taylor", role: "Hair Specialist", img: "team-1.jpg" },
              { name: "Olivia Smith", role: "Nail Designer", img: "team-2.jpg" },
              { name: "Ava Brown", role: "Beauty Specialist", img: "team-3.jpg" },
              { name: "Amelia Jones", role: "Spa Specialist", img: "team-4.jpg" },
            ].map((member, index) => (
              <div key={index} className="relative group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center">
                  ...
                  <h4 className="text-white text-xl font-bold mb-4">{member.name}</h4>
                  <div className="flex gap-3">
                    <a href="#" className="w-10 h-10 flex items-center justify-center bg-gray-800 text-white border-2 border-gray-700 hover:bg-[#d4a574] hover:border-[#d4a574] transition-colors">
